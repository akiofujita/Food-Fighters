...
def main():
    # You can insert any allrecipe link that you want here
    scraper = scrape_me('https://www.allrecipes.com/recipe/147103/delicious-egg-salad-for-sandwiches/')
    scrape_and_write(scraper)
    # Or any .csv file containing a column of allrecipe links
    '''
